        ...
        >
            <div className="relative rounded-xl border border-background bg-secondary focus-within:border-primary">
                <textarea
                    ...
                    onPaste={onPaste}
                    onKeyDown={onKeyDown}
                    className="w-full resize-none rounded-xl bg-transparent p-3 text-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
